...
class HospitalityServiceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if(appTheme == APP_THEME_LIGHT)
            view = inflater.inflate(R.layout.fragment_hospitality_service_phone_light, container, false)
        else
            view = inflater.inflate(R.layout.fragment_hospitality_service_phone_dark, container, false)

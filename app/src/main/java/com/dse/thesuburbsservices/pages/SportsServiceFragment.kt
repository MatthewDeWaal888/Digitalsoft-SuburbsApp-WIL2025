...
class SportsServiceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_sports_service_phone_light, container, false)
        ...
        tvHeading.text = AppData.sportsService?.heading
        tvContent.text = AppData.sportsService?.content
